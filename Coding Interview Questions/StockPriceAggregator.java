...
/*
Design Stock Price Aggregator
(update prices, get latest, min, max, handle corrections)

You are building a system that tracks stock prices over time, where:

Prices can be updated (even corrected later)
